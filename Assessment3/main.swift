...
func printSchedule(class1 : String, class2 : String, class3 : String){
    print("Class One: \(class1) Class Two: \(class2) Class Three: \(class3)")
}


printSchedule(class1: "GEOMETRY", class2: "ENGLSIH", class3: "Lunch")
...
multiplyArray(intArray: [1,2,3,4])
...
var inventory = [1: "CEREAL", 2 : "BANANA", 3 : "CUCUMBER", 4 : "FORKS", 5 : "PLATES"]
